...
$sql=mysqli_query($con,"insert into category(cname,comid) values('$cname','$vv')");
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add Job Category </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: left;">Add Job Category</h4>
					<br>
