        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <h2 class="content-heading">Update Vacancy</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Update Job Vacancy</h3>
...
<form action="edtaction.php" method="POST">
                      ...
                      $sel1=mysqli_query($con,"select * from category where comid='$vv'"); 
                      ?>
                                </div>
...
document.getElementById('msg001').innerHTML=" ";
    return true;
                                            ...
                                            <?php
                      $sell=mysqli_query($con,"select * from tbl_qualification where comid=$vv and qstatus=1"); 
                      ...
                      ?>
                         ...
                         <?php  } ?>
                                             ...
                                             <?php
                      $sell=mysqli_query($con,"select * from tbl_location where comid=$vv and lstatus=1"); 
