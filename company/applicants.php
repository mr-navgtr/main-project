             ...
             <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"> List Of Applicants</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">List Of Applicants</h4>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Applied Date</th>
...
{?>
     ...
     <td><?php echo $r['preferdsex'];?></td>
     <td><?php echo $r['dateofpost'];?></td> -->

		<td><a style="color:blue" href="viewapplicantdetails.php?jid=<?php echo $r['jobid'];?>"><b>View Details</a></td>
