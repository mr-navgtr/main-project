        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title">View Applicant Details By Location</h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0">View Applicant Details By Location </a>
                    </div>
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      
                      <div class="form-group">
                        <label for="exampleInputName1"> Select Location Name</label>
                        <select class="form-control"name="location" required >
                          <option> </option>
                          <?php
                $conn = mysqli_connect('localhost', 'root', '', 'job1');
                $query = mysqli_query($conn, "select * from tbl_location where comid='$vv'");
