			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>View Applied Job Details</h2>
...
$sql="SELECT tbljob.*,applicants.*,category.*,sub_category.* from tbljob,applicants,sub_category,category where tbljob.jobid=applicants.jobid and tbljob.cid=category.cid and sub_category.subid=tbljob.subid";
...
{?>
        ...
        <td><a href="viewjobdetails.php?id=<?php echo $r['jobid'] ?>">view More Details</a></td></tr>
