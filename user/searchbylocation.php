	...
	<div class="reservation-box">
		<div class="container">
			...
			<div class="row">
                ...
                $query = mysqli_query($conn, "select * from tbl_location where lstatus=1");
...
<?php
include '../connection.php';
$sql="select * from tbljob j,category c,sub_category s where j.jstatus='active' and  j.duration >=CURDATE() and j.cid=c.cid and s.subid=j.subid and s.cid=c.cid and j.location='$pid'";
