                                        ...
                                        <div class="row contentbody">
                                            <div class="col-sm-6">
                                                <ul>
                                                    ...
                                                    <li><i class="fa fa-sun-"></i>Duration of Application :<?php echo $r['duration'];?> </li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <p>Work Experience :<?php echo $r['workexp'];?></p>
                                                 <ul style="list-style: none;"> 
                                                    <li></li> 
                                                </ul> 
                                            </div>
                                            <div class="col-sm-12">
                                                <p>Qualification :<?php echo $r['qualifi'];?></p>
                                                 <ul style="list-style: none;"> 
                                                    <li></li> 
                                                </ul> 
                                            </div>
                                          ...
                                          <a href="jobapplicationsubmission.php?id=<?php echo $r['jobid'] ?>&comid=<?php echo $comid ?>" class="btn btn-main btn-next-tab">Apply Now !</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
