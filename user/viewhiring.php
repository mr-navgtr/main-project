			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
                    ...
                    <li class="nav-item "><a class="nav-link" href="index.php">Home</a></li>
                        <li class="nav-item active"><a class="nav-link" href="viewhiring.php">Hiring</a></li>
...
<?php
include '../connection.php';
$sql="select * from tbljob j,category c,sub_category s,tbl_company y where  j.cid=c.cid and s.subid=j.subid and y.comid=j.comid and j.duration >=CURDATE() and j.jstatus='active' ";
...
{?>
        ...
        <td><?php echo $r['duration'];?></td>
         <td><a href="viewjob.php?id=<?php echo $r['jobid'] ?>&comid=<?php echo $r['comid'] ?>">view job</a></td></tr> 
                      <?php
}
?></tbody>
                    </table>
